Public NotInheritable Class SplashScreen1
    ...
    'TODO: 프로젝트 디자이너에서 "프로젝트" 메뉴의 "속성"을 선택하여 표시된 "애플리케이션" 탭에서
    '  이 폼을 응용 프로그램의 시작 화면으로 쉽게 설정할 수 있습니다.


    Private Sub SplashScreen1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '애플리케이션의 어셈블리 정보에 따라 런타임에 대화 상자 텍스트를 설정합니다.  

        'TODO: "프로젝트" 메뉴에서 선택하여 표시되는 프로젝트 속성 대화 상자의 "애플리케이션" 창에서 애플리케이션의 
        '  어셈블리 정보를 사용자 지정합니다.

        '스플레쉬 사진

        ' MainLayoutPanel = My.Resources._1920px_Mitutoyo_company_logo
        ...
        ' Else
        '애플리케이션 제목이 없는 경우 확장명 없이 애플리케이션 이름을 사용합니다.
