Public Class Form10
    ...
    Public select_pic_name_3 As String
    ...
    Private Sub Form7_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        origin_image_2 = My.Resources._1920px_Mitutoyo_company_logo_sample
        origin_image_3 = My.Resources.sample_work
        ...
        If Form1.New_Fix_check = 0 Then
            ...
            PictureBox4.Image = origin_image_3
        ...
        If Form1.New_Fix_check = 1 Then
            ...
            select_pic_name_3 = Form1.user_info_temp(12)
            ...
            If select_pic_name_2 = "" Then
                PictureBox3.Image = origin_image_2
            Else
            ...
            If select_pic_name_3 = "" Then
                PictureBox4.Image = origin_image_3
            Else
                PictureBox4.Image = New Bitmap(select_pic_name_3)
            End If
        ...
        If Form1.New_Fix_check = 2 Then         '2 수정 버튼
            ...
            If 수정창.User_Info_Value(12) = "" Then
                PictureBox4.Image = origin_image_3
                select_pic_name_3 = ""
            Else
                PictureBox4.Image = New Bitmap(수정창.User_Info_Value(12))
            End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click           '확인
        ...
        If select_pic_name_3 = "" Then
            Form1.user_info_temp(12) = ""
        Else
            Form1.user_info_temp(12) = select_pic_name_3
        End If
        ...
        If select_pic_name = "" Then
            select_image = My.Resources._1920px_Mitutoyo_company_logo_sample
        Else
            select_image = New Bitmap(select_pic_name)
        End If

        If select_pic_name_2 = "" Then
            select_image_2 = My.Resources._1920px_Mitutoyo_company_logo_sample
        Else
            select_image_2 = New Bitmap(select_pic_name_2)
        End If

        If select_pic_name_3 = "" Then
            select_image_3 = My.Resources.sample_work
        Else
            select_image_3 = New Bitmap(select_pic_name_3)
        End If
    ...
    Private Sub PictureBox4_Click(sender As Object, e As EventArgs) Handles PictureBox4.Click
        origin_image_3 = PictureBox4.Image
        ...
        If select_pic_name_3 = "" Then
            ...
            If ofd_For_Csv.ShowDialog() = Windows.Forms.DialogResult.OK Then
                change_image = New Bitmap(ofd_For_Csv.FileName)
                PictureBox4.Image = change_image
                select_pic_name_3 = ofd_For_Csv.FileName
            End If
        ...
        Else
            ...
            Select Case Form12.DialogResult
                ...
                Case 1      '삭제
                    ...
                    PictureBox4.Image = My.Resources.sample_work
                    select_pic_name_3 = ""
