Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        ReDim ini_KeyName(10)

        Kill_name = Form1.ListBox1.SelectedItem.ToString
        kill_dir = CurDir() & "\MRM\Data\Resources\ini\" & Form1.ListBox1.SelectedItem.ToString & ".ini"
        ini_Dir = CurDir() & "\MRM\Data\Resources\ini\" & Form1.ListBox1.SelectedItem.ToString & ".ini"
        ...
        TextBox1.Text = GetINIValue(ini_section, ini_KeyName(0), ini_Dir)
        TextBox2.Text = GetINIValue(ini_section, ini_KeyName(1), ini_Dir)
        TextBox3.Text = Form1.ListBox1.SelectedItem.ToString
        TextBox4.Text = GetINIValue(ini_section, ini_KeyName(2), ini_Dir)
        ComboBox1.SelectedItem = GetINIValue(ini_section, ini_KeyName(3), ini_Dir)
        CheckBox1.Checked = GetINIValue(ini_section, ini_KeyName(7), ini_Dir)
        CheckBox2.Checked = GetINIValue(ini_section, ini_KeyName(8), ini_Dir)
        CheckBox11.Checked = GetINIValue(ini_section, ini_KeyName(9), ini_Dir)

        radio_jugde = GetINIValue(ini_section, ini_KeyName(5), ini_Dir)
        ...
        Else
            ...
            check_keyname(7) = "line_count"
            check_keyname(8) = "component"

            CheckBox3.Checked = GetINIValue(check_section, check_keyname(0), ini_Dir)
            CheckBox4.Checked = GetINIValue(check_section, check_keyname(1), ini_Dir)
            CheckBox5.Checked = GetINIValue(check_section, check_keyname(2), ini_Dir)
            CheckBox6.Checked = GetINIValue(check_section, check_keyname(3), ini_Dir)
            CheckBox7.Checked = GetINIValue(check_section, check_keyname(4), ini_Dir)
            CheckBox8.Checked = GetINIValue(check_section, check_keyname(5), ini_Dir)
            CheckBox9.Checked = GetINIValue(check_section, check_keyname(6), ini_Dir)
            CheckBox10.Checked = GetINIValue(check_section, check_keyname(8), ini_Dir)
            ...
            TextBox5.Text = GetINIValue(Result_Section, Result_Keyname(0), ini_Dir)
            TextBox6.Text = GetINIValue(Result_Section, Result_Keyname(1), ini_Dir)
            TextBox7.Text = GetINIValue(Result_Section, Result_Keyname(2), ini_Dir)
            TextBox8.Text = GetINIValue(Result_Section, Result_Keyname(3), ini_Dir)
            TextBox9.Text = GetINIValue(Result_Section, Result_Keyname(4), ini_Dir)
            TextBox10.Text = GetINIValue(Result_Section, Result_Keyname(5), ini_Dir)
            TextBox11.Text = GetINIValue(Result_Section, Result_Keyname(6), ini_Dir)
            TextBox12.Text = GetINIValue(Result_Section, Result_Keyname(7), ini_Dir)
            TextBox14.Text = GetINIValue(Result_Section, Result_Keyname(9), ini_Dir)

            TextBox13.Text = GetINIValue(Result_Section, Result_Keyname(8), ini_Dir)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click       '저장
        ...
        Else    '기본 선택시 ini에 위치선택 속성 공백 지정하여 넣기
            ...
            ' If check_value(p) = True Then
            ' If Result_Value(p) = "" Then
            ' MsgBox("셀 주소에 공백이 있습니다. 셀 주소를 확인해 주세요")
            ' Exit Sub
            ' End If
            ' End If
            '     Next
            ...
            WPPS(check_section, Result_Keyname(0), check_value(0), ini_Dir)
            WPPS(check_section, Result_Keyname(1), check_value(1), ini_Dir)
            WPPS(check_section, Result_Keyname(2), check_value(2), ini_Dir)
            WPPS(check_section, Result_Keyname(3), check_value(3), ini_Dir)
            WPPS(check_section, Result_Keyname(4), check_value(4), ini_Dir)
            WPPS(check_section, Result_Keyname(5), check_value(5), ini_Dir)
            WPPS(check_section, Result_Keyname(6), check_value(6), ini_Dir)
            WPPS(check_section, Result_Keyname(7), check_value(7), ini_Dir)
