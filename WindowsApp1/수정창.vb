Public Class 수정창
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Else            '위치 지정
            ...
            CheckBox3.Checked = GetINIValue(check_section, check_keyname(0), Restore_str(ini_Dir))
            CheckBox4.Checked = GetINIValue(check_section, check_keyname(1), Restore_str(ini_Dir))
            CheckBox5.Checked = GetINIValue(check_section, check_keyname(2), Restore_str(ini_Dir))
            CheckBox6.Checked = GetINIValue(check_section, check_keyname(3), Restore_str(ini_Dir))
            CheckBox7.Checked = GetINIValue(check_section, check_keyname(4), Restore_str(ini_Dir))
            CheckBox8.Checked = GetINIValue(check_section, check_keyname(5), Restore_str(ini_Dir))
            CheckBox9.Checked = GetINIValue(check_section, check_keyname(6), Restore_str(ini_Dir))
            CheckBox10.Checked = GetINIValue(check_section, check_keyname(8), Restore_str(ini_Dir))
            ...
            TextBox5.Text = GetINIValue(Result_Section, Result_Keyname(0), Restore_str(ini_Dir))
            TextBox6.Text = GetINIValue(Result_Section, Result_Keyname(1), Restore_str(ini_Dir))
            TextBox7.Text = GetINIValue(Result_Section, Result_Keyname(2), Restore_str(ini_Dir))
            TextBox8.Text = GetINIValue(Result_Section, Result_Keyname(3), Restore_str(ini_Dir))
            TextBox9.Text = GetINIValue(Result_Section, Result_Keyname(4), Restore_str(ini_Dir))
            TextBox10.Text = GetINIValue(Result_Section, Result_Keyname(5), Restore_str(ini_Dir))
            TextBox11.Text = GetINIValue(Result_Section, Result_Keyname(6), Restore_str(ini_Dir))
            TextBox12.Text = GetINIValue(Result_Section, Result_Keyname(7), Restore_str(ini_Dir))
            TextBox14.Text = GetINIValue(Result_Section, Result_Keyname(9), Restore_str(ini_Dir))

            TextBox13.Text = GetINIValue(Result_Section, Result_Keyname(8), Restore_str(ini_Dir))

            ComboBox2.SelectedItem = GetINIValue(Result_Section, Result_Keyname(10), Restore_str(ini_Dir))
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click       '저장(수정  버튼)
        ...
        ReDim Preserve User_Info_Value(15)
        ...
        If RadioButton2.Checked = True Then
            ...
            For p = 0 To 7
                If check_value(p) = True Then
                    If Result_Value(p) = "" Then
                        MsgBox("셀 주소에 공백이 있습니다. 셀 주소를 확인해 주세요",, "셀 주소 기입 오류")
                        Exit Sub
                    End If
                End If
            Next
            ...
            If Result_Value(7) = "" Then        '페이지당 줄수 
                MsgBox("페이지당 줄수는 필수 입니다. 기입해 주세요",, "페이지 줄 수 기입 오류")
                Exit Sub
            End If
